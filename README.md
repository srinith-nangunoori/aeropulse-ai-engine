...
Built on a decoupled microservice architecture featuring a **Python (FastAPI + SQLAlchemy) MLOps Backend** connected to a **Cloud PostgreSQL (NeonDB) database**, and a **React (Vite + Tailwind CSS) Human-in-the-Loop Console**.

---

## Live Production Demo

*   **Interactive Web Dashboard (Vercel):** [https://aeropulse-ai-engine.vercel.app](https://aeropulse-ai-engine.vercel.app)
*   **Interactive REST API Swagger Docs (Render):** [https://aeropulse-api.onrender.com/docs](https://aeropulse-api.onrender.com/docs)
...
2. **The State Machine (PostgreSQL + SQLAlchemy):** A normalized relational database hosted on NeonDB maintains strict ACID compliance across three ledgers: `inventory_ledger`, `maintenance_logs`, and `procurement_orders`.
...
*   **Backend Server & ORM:** FastAPI, Uvicorn, SQLAlchemy, Pydantic, Python-Dotenv
...
### Step 1: Vision Backend Setup & Database Initialization
...
# Install exact dependency pipeline (including Postgres and Dotenv adapters)
pip install fastapi uvicorn sqlalchemy pandas scikit-learn joblib psycopg2-binary python-dotenv

# Create .env file inside backend/ and add your database URL:
# DATABASE_URL="postgresql://user:password@url.neon.tech/neondb?sslmode=require"

# Forge the Database, Seed Inventory, and Train V1.0 Model
...
### Step 2: React Overseer Console Setup
